    ...
    <div className="flex flex-col pt-24 selection:bg-accent/20">
            ...
            <div className="relative z-10 px-6 py-10 md:px-12 md:py-16 flex flex-col lg:flex-row gap-8 lg:gap-16 items-center lg:items-center justify-between">
              <div className="flex-1 text-center lg:text-left">
                ...
                <p className="text-zinc-600 dark:text-white/70 text-base md:text-lg max-w-xl mx-auto lg:mx-0">
                  Don&apos;t just take my word for it. Explore exactly how we&apos;ve
                  helped businesses scale their digital presence through
                  strategic design.
                </p>
              </div>
              ...
              <div className="w-full lg:w-auto grid grid-cols-2 gap-4 shrink-0">
                <div className="p-5 md:p-6 rounded-2xl bg-white border border-zinc-200 shadow-sm dark:shadow-none dark:bg-white/5 backdrop-blur-md dark:border-white/10 flex flex-col justify-center items-center lg:items-start transition-transform hover:-translate-y-1 hover:shadow-md dark:hover:shadow-none">
                  <h3 className="text-3xl md:text-4xl font-black text-zinc-900 dark:text-white font-syne mb-1">
                    300<span className="text-accent">+</span>
                  </h3>
                  <p className="text-[10px] md:text-xs font-bold text-zinc-600 dark:text-white/50 uppercase tracking-[0.2em]">
                    Projects
                  </p>
                </div>
                <div className="p-5 md:p-6 rounded-2xl bg-orange-50/50 border border-orange-100 shadow-sm dark:shadow-none dark:bg-accent/10 backdrop-blur-md dark:border-accent/20 flex flex-col justify-center items-center lg:items-start transition-transform hover:-translate-y-1 hover:shadow-md dark:hover:shadow-none relative overflow-hidden">
                  ...
                  <h3 className="text-3xl md:text-4xl font-black text-accent font-syne mb-1 relative z-10">
                    4.9<span className="text-xl text-accent/50">/5</span>
                  </h3>
                  <p className="text-[10px] md:text-xs font-bold text-accent/80 uppercase tracking-[0.2em] relative z-10">
                    Avg Rating
                  </p>
                </div>
                <div className="p-5 md:p-6 rounded-2xl bg-white border border-zinc-200 shadow-sm dark:shadow-none dark:bg-white/5 backdrop-blur-md dark:border-white/10 flex flex-col justify-center items-center lg:items-start transition-transform hover:-translate-y-1 hover:shadow-md dark:hover:shadow-none">
      ...
      <section className="flex-1 max-w-7xl mx-auto w-full px-4 py-8 md:py-16 relative z-10">
        <div className="mb-16 text-center">
          <h2 className="text-4xl md:text-5xl font-black font-syne text-text-primary tracking-tight">
            Loved by Clients.
          </h2>
        </div>
          ...
          <>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-4 mb-6 relative z-10">
                      <div
                        className={`w-14 h-14 rounded-full border border-border/50 flex items-center justify-center font-black text-xl overflow-hidden shrink-0 shadow-inner uppercase ${colorClass}`}
                      >
                      ...
                      <div>
                        <h3 className="font-bold text-text-primary text-lg font-syne">
                          {review.name}
                        </h3>
                        <p className="text-xs font-semibold text-accent/80 font-mono tracking-wide">
                          {review.role}
                        </p>
                      </div>
                    </div>
            ...
            {visibleCount < reviews.length && (
              <div className="mt-20 flex justify-center relative z-10">
                <button
                  onClick={loadMore}
                  className="group px-10 py-4 bg-text-primary hover:bg-accent text-background dark:text-background dark:hover:text-white rounded-full font-bold text-sm transition-all duration-300 shadow-xl hover:shadow-accent/25 flex items-center gap-3 hover:-translate-y-1 cursor-pointer"
                >
