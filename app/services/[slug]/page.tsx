...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return createPageMetadata({
    ...
    keywords: [
      ...
      `${service.title.toLowerCase()} expert`,
      `hire ${service.title.toLowerCase()}`,
      `best ${service.title.toLowerCase()} developer`,
  ...
  return (
    <>
      ...
      <article className="min-h-screen bg-background relative pt-32 md:pt-40">
        ...
        <div
          className={`absolute top-0 left-0 w-full h-[60vh] bg-gradient-to-b from-accent/20 to-transparent blur-[120px] pointer-events-none`}
        />
        ...
        <div className="bg-surface border-y border-border py-24">
          <div className="max-w-7xl mx-auto px-6">
            <div className="mb-16">
              <p className="text-accent text-[10px] md:text-xs font-bold uppercase tracking-widest mb-4">
                What you get
              </p>
              <h2 className="font-syne font-black text-3xl md:text-[42px] text-text-primary">
              ...
              {(service.features || []).map((feature: string) => (
                <PremiumGlowCard key={feature} className="!bg-surface-2/20">
                  ...
                  <p className="text-text-secondary text-base leading-relaxed">
                    Meticulously engineered to ensure your digital presence is
                    not only beautiful but also high-performing and scalable.
                  </p>
                </PremiumGlowCard>
              ))}
            </div>
        ...
        {relatedProjects && relatedProjects.length > 0 && (
          <div className="py-24 max-w-7xl mx-auto px-6">
            <div className="mb-12 flex justify-between items-end gap-6 flex-wrap">
              ...
              <Link
                href="/#work"
                className="text-text-muted hover:text-accent font-bold text-sm flex items-center gap-2 group transition-colors"
              >
                View All Projects
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {relatedProjects.map((project: any) => (
                <Link
                  ...
                  className="group relative rounded-3xl overflow-hidden border border-border aspect-video"
                >
                  <img
                    src={project.image}
                    alt={project.title}
        ...
        <div className="py-32 relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
            ...
            <h2 className="font-syne font-black text-3xl md:text-[42px] text-text-primary mb-8">
              Ready to Scale Your Business?
            </h2>
            <p className="text-text-secondary text-base md:text-lg mb-12 max-w-2xl mx-auto">
              Let's discuss how my expert {service.title} can transform your
              digital strategy and deliver measurable ROI.
            </p>
            <Link
              href="/#contact"
